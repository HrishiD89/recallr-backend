...
import com.recallr.common.util.TsidGenerator;
import com.recallr.domain.content.Content;
import com.recallr.domain.content.Tag;
...
public class User {
    ...
    @GenericGenerator(name = "tsid", type = com.recallr.common.util.TsidGenerator.class)
    private Long id;
